...
└── cli.py         — thin Click CLI entry point (51 commands: start/send/stop/status/merge/diff/kill/list/monitor/watch/dashboard/logs/inspect/stats/batch/queue/recover/resume/retry/export/audit/cleanup/init/doctor/config/version/completion/bench/think/cost/events + CEO workflow commands)
```
...
- 2001+ tests, **100% test coverage required** (enforced via `make coverage`)
