...
└── cli.py         — thin Click CLI entry point (35 commands: start/send/stop/status/merge/diff/kill/list/monitor/watch/dashboard/logs/inspect/stats/batch/queue/recover/resume/retry/export/audit/cleanup/init/doctor/config/version/completion/think/cost/events/go + CEO workflow commands)
```
